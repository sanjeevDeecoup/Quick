    ...
    public string GetBookingDetailsForBookingNumberProcessRate(string BookNumber, string date)
    {
        ...
        START:
            ...
            if (PrintDueDate)
            {
                ...
                strPreview3 += "<tr style='font-size:12px'><td colspan='4' align='center'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;'><tr><td style='font-weight:bold;font-size:12px'>S.No. :&nbsp;" + totalItem + "</td><td style='width:2.0in;' align='right'><table><tr><td style='font-weight:bold;font-size:12px'></td><td style='font-size:12px'>" + dsMain.Tables[0].Rows[0]["BookingRemarks"].ToString() + "</td></tr></table></td><td align='center' style='width:4.0in' ><table><tr><td style='font-weight:bold;font-size:12px'>Due Date :&nbsp;</td><td style='font-size:13px'> " + dsMain.Tables[0].Rows[0]["DeliveryTime"].ToString() + " / " + Convert.ToDateTime(dsMain.Tables[0].Rows[0]["DeliveryDate"].ToString()).DayOfWeek.ToString() + " / " + dsMain.Tables[0].Rows[0]["DeliveryDate"].ToString() + "</td></tr></table></td></tr></table></td></tr>";
                if (strPreview2.Contains("Total Pcs."))
                { }
                else
                {
